//! SalaryStructure DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new SalaryStructure
///
...
/// Request DTO for full update of a SalaryStructure
///
...
/// Request DTO for partial update of a SalaryStructure
///
...
/// Response DTO for SalaryStructure entity
///
...
/// Paginated list response for SalaryStructure entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct SalaryStructureListResponseDto {
    /// List of items
    pub items: Vec<SalaryStructureResponseDto>,
...
impl SalaryStructureListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<SalaryStructureResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<SalaryStructure> for SalaryStructureResponseDto {
...
impl From<SalaryStructure> for SalaryStructureSummaryDto {
    fn from(entity: SalaryStructure) -> Self {
...
impl From<CreateSalaryStructureDto> for SalaryStructure {
...
impl backbone_core::FromCreateDto<CreateSalaryStructureDto> for SalaryStructure {
    fn from_create_dto(dto: CreateSalaryStructureDto) -> backbone_core::ServiceResult<Self> {
        Ok(SalaryStructure::from(dto))
    }
}
