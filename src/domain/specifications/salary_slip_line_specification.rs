//! Specifications for SalarySlipLine aggregate
//!
...
// Each predicate implements `Specification<SalarySlipLine>` and can be combined
...
//
// pub struct ActiveSalarySlipLineSpec;
// impl Specification<SalarySlipLine> for ActiveSalarySlipLineSpec {
//     fn is_satisfied_by(&self, e: &SalarySlipLine) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
