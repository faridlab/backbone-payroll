//! Specifications for SalaryStructure aggregate
//!
...
// Each predicate implements `Specification<SalaryStructure>` and can be combined
...
//
// pub struct ActiveSalaryStructureSpec;
// impl Specification<SalaryStructure> for ActiveSalaryStructureSpec {
//     fn is_satisfied_by(&self, e: &SalaryStructure) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
