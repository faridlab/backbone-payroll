//! Domain policy for SalarySlip aggregate
//!
...
/// Domain policy for SalarySlip — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<SalarySlip>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type SalarySlipDomainPolicy = PermitAllPolicy<SalarySlip>;
